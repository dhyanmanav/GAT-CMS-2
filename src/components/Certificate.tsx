...
import signatureImg from 'figma:asset/017a45a825bbb3914d7dda6ecb3244e684d763ac.png';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div id="certificate-content" ref={certificateRef} style={{ 
          ...
          <div style={{ flex: '1', display: 'flex', flexDirection: 'column' }}>
            ...
            {/* Reference and Date */}
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid #000000' }}>
              <div>
            ...
            {/* Content */}
            <div style={{ marginBottom: '48px', fontSize: '18px', lineHeight: 2.2 }}>
              <p style={{ color: '#111827', marginBottom: '32px', margin: '0 0 32px 0', textAlign: 'justify' }}>
              ...
              <p style={{ color: '#111827', marginBottom: '48px', margin: '0 0 48px 0', textAlign: 'justify' }}>
